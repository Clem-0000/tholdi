...
function modifierReservation($id, $dateDebutReservation, $datefinReservation,$codeVilleMiseDisposition, $codeVilleRendre){
    $pdo = gestionnaireDeConnexion();
    $req = "UPDATE RESERVATION SET dateDebutReservation = $dateDebutReservation, SET datefinReservation = $datefinReservation, SET codeVilleMiseDisposition = $codeVilleMiseDisposition, SET codeVilleRendre = $codeVilleRendre WHERE codeReservation = $id";
$pdo->exec($req);
}
